...
class _ParallelCrossEntropy(torch.autograd.Function):
    @staticmethod
    def forward(ctx, vocab_parallel_logits, target, label_smoothing=0.0, ignore_index=-100):
        pass
        ...
        ctx.label_smoothing, ctx.vocab_size, ctx.ignore_index = label_smoothing, vocab_size, ignore_index
...
def parallel_cross_entropy(vocab_parallel_logits, target, label_smoothing=0.0, ignore_index=-100):
